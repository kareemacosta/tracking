...
contract Tracking {
    ...
    uint256 indexed pickupTime, uint256 distance, uint256 price);

    event ShpitmentInTransit(address indexed sender, address indexed receiver, uint256 pickupTime);
    ...
    public payable {
       require(msg.value == _price, "Price must be equal to msg.value");
        ...
        typeShipments.push(TypeShipment(msg.sender, _receiver, _pickupTime, 0, _distance,
        _price, ShipmentStatus.PENDING, false));
        ...
        function startShipment (address _sender, address _receiver, uint256 _index) public {
                ...
                emit ShpitmentInTransit(_sender, _receiver, shipment.pickupTime);
        }
